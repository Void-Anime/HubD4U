...
export default function Navbar() {
  ...
  return (
    <header className={`sticky top-0 z-40 transition-colors ${scrolled ? 'bg-black/80' : 'bg-gradient-to-b from-black/80 to-transparent'} backdrop-blur border-b border-white/5`}>
